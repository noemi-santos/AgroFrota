...
@section('conteudo')
    ...
    <div class="text-center my-5">
        <h1 class="display-4 fw-bold">Bem-vindo ao AgroFrota - Cliente HOME-CLI</h1>
    ...
    <div class="container mt-5"> <!-- Adicionei mt-5 para espaçar abaixo do título -->
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <a href="/buscar" class="btn btn-primary btn-sm w-100">
            ...
            <!-- Card Equipamentos -->
            <div class="col-lg-3 col-md-6 col-sm-12">
                <a href="/anunciar" class="btn btn-primary btn-sm w-100">
                    <div class="card-body shadow-sm border-0 rounded-3">
                        <div class="card-body p-3 text-center">
